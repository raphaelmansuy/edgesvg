        ...
        Commands::Benchmark {
            ...
            println!(
                ...
                serde_json::to_string_pretty(&json!({
                    ...
                    "dataset_health_score": report.dataset_health_score,
                    "balanced_group_score": report.balanced_group_score,
                    "balanced_subgroup_score": report.balanced_subgroup_score,
                    "balanced_kind_complexity_score": report.balanced_kind_complexity_score,
                    "average_reliability_score": report.average_reliability_score,
                    "average_efficiency_score": report.average_efficiency_score,
                    "average_fidelity_score": report.average_fidelity_score,
                    "average_ssim": report.average_ssim,
                    "average_local_ssim_p10": report.average_local_ssim_p10,
